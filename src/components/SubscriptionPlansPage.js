...
const SubscriptionPlansPage = () => {
  ...
  const handleCancelSubscription = async () => {
    ...
    try {
      ...
      if (result.success) {
        alert('Your subscription has been cancelled successfully. Thank you for being a customer!');
      } else {
  ...
  return (
    <div className="subscription-page">
      ...
      <div className="main-content">
        ...
        {isPaidUser && subscription?.status === 'active' && subscription?.plan === 'study' && (
          <div className="cancel-subscription-section">
            <div className="cancel-card">
              <div className="cancel-content">
                <h3 className="cancel-title">Need to cancel your subscription?</h3>
                <p className="cancel-description">
                  You can cancel your monthly subscription at any time. You'll lose access to paid features immediately.
                </p>
                <button
