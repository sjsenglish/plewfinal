...
const SubscriptionPlansModal = ({ onClose }) => {
  ...
  const handleUpgrade = async (plan) => {
    ...
    try {
      console.log('Opening Stripe payment link for plan:', plan.id);
      console.log('User ID:', user.uid);
      console.log('User Email:', user.email);
      
      // Use the provided Stripe payment link
      window.open('https://buy.stripe.com/8x23cxcsjfHl2Lw08d8EM01', '_blank');
